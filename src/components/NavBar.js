...
class Navbar extends Component {
  render() {
    ...
    background: "linear-gradient(rgb(8, 77, 121),rgba(0, 53, 89, 1))",
              ...
              minWidth: "120px"}} >
          <Menu.Item>
            <Link to="/" style={{ color: "rgb(161, 233, 29)"}} >Login Page</Link>
          </Menu.Item>
          <Menu.Item>
            <Link to="/home" style={{ color: "rgb(161, 233, 29)"}} >Calendar Page</Link>
          </Menu.Item>
          <Menu.Item>
            <Link to="/profile" style={{ color: "rgb(161, 233, 29)"}} >Profile Page</Link>
          </Menu.Item>
          <Menu.Item>
